...
Feature: As a user, I should be able to manage the cart by clicking the cart icon.
  ...
  4- Verify that the user should be able to navigate to the Checkout page from the cart icon and complete the payment.
  5- Verify that the user can enter a new Shipping address during checkout.
  6 - Verify that the user can enter a new billing address during checkout.
  7 - Verify that the user can continue shopping from the cart.
  ...
  Scenario Outline: Delivery adresse-Negative Test
    ...
    Examples:
      ...
      | Ahmet                               | Yanbasar                                 | ankara cad.                                                                                                                                     | a                                                                                                                                             | 34843         | City must be between 2 and 128 characters!      |
      | Ahmet                               | Yanbasar                                 | ankara cad.                                                                                                                                     | istanbulll istanbulllistanbulllistanbulllistanbulllistanbulllistanbulllistanbulllistanbulllistanbulllistanbulllistanbulllistanbulllistanbulll | 34843         | City must be between 2 and 128 characters!      |
      | Ahmet                               | Yanbasar                                 | ankara cad.                                                                                                                                     | istanbulll                                                                                                                                    |               | Postcode must be between 2 and 10 characters!   |
      | Ahmet                               | Yanbasar                                 | ankara cad.                                                                                                                                     | istanbulll                                                                                                                                    | 1             | Postcode must be between 2 and 10 characters!   |
      | Ahmet                               | Yanbasar                                 | ankara cad.                                                                                                                                     | istanbulll                                                                                                                                    | 3484314578963 | Postcode must be between 2 and 10 characters!   |
